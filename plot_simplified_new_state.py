...
array_new = np.loadtxt("simplified_actuator_tc_long_data_cycle_0_3.csv", delimiter=",")
array_new_2 = np.loadtxt("simplified_actuator_tc_long_data_cycle_1_3.csv", delimiter=",")
...
plt.plot(time_arr, array_true[:, :], label="true w_0")
plt.legend(loc="upper left")
plt.show()
